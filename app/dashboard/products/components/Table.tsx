  ...
  if (data) {
    ...
    return (
      <div className="space-y-2">
        <Table className="bg-foreground rounded">
          <TableCaption className="text-secondary">{`Showing ${page} out of ${lastPage} page(s).`}</TableCaption>

          <TableHeader>
            <TableRow className="divide-gray-800 border-gray-800 text-secondary">
            ...
            {announcements.length > 0 &&
              announcements.map((post) => (
                ...
                >
                  ...
                  <TableCell className="text-right">
                    <Link href={`/dashboard/products/${post.id}`}>
